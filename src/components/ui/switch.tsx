...
interface SwitchProps extends Omit<HTMLAttributes<HTMLDivElement>, "onChange"> {
  /** When set, shown beside the control (e.g. compact toolbar). Settings use an external `<label htmlFor>`. */
  label?: string
  checked: boolean
...
const Switch = forwardRef<HTMLDivElement, SwitchProps>(
  (
    ...
    }, [checked, onCheckedChange, motionX])
    ...
    return (
      <div
        ...
        className={cn(
          ...
          label ? "gap-2.5 px-3 py-2" : "inline-flex",
        ...
        >
          <SwitchPrimitive.Thumb asChild>
            <motion.span
              ...
              transition={
                hasMounted.current ? springs.moderate : { duration: 0 }
              }
            />
